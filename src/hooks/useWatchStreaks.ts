    ...
    return [
      {
        ...
        description: 'Regardez votre tout premier épisode',
      ...
      },
      {
        id: 'genin',
        title: 'Genin',
        description: 'Regardez 5 épisodes — le voyage commence',
      ...
      },
      {
        id: 'chunin',
        title: 'Chunin',
        description: 'Atteignez 10 épisodes regardés',
      ...
      },
      {
        id: 'plus-ultra',
        title: 'Plus Ultra',
        description: 'Regardez 35 épisodes — allez plus loin !',
      ...
      },
      {
        id: 'pro-hero',
        title: 'Pro Hero',
        description: 'Regardez 50 épisodes — vous êtes un héros',
      ...
      },
      {
        id: 'soul-reaper',
        title: 'Soul Reaper',
        description: 'Explorez 25 séries d\'anime différentes',
      ...
      },
      {
        id: 'bankai',
        title: 'Bankai',
        description: 'Atteignez 100 épisodes regardés au total',
      ...
      },
      {
        id: 'survey-corps',
        title: 'Survey Corps',
        description: 'Explorez 50 séries d\'anime différentes',
      ...
      },
      {
        id: 'demon-slayer',
        title: 'Demon Slayer',
        description: 'Accumulez 5000+ minutes de visionnage',
      ...
      },
      {
        id: 'hashira',
        title: 'Hashira',
        description: 'Regardez 600 épisodes — un vrai Pilier',

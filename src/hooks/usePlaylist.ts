...
export function useCreatePlaylist() {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      toast.error(`Échec de la création de la playlist : ${error.message}`);
    },
  });
}
...
export function useUpdatePlaylist() {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      toast.error(`Échec de la mise à jour de la playlist : ${error.message}`);
    },
  });
}
...
export function useDeletePlaylist() {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      toast.error(`Échec de la suppression de la playlist : ${error.message}`);
    },
  });
}
...
export function useRemoveFromPlaylist() {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      toast.error(`Échec du retrait : ${error.message}`);
    },
  });
}
...
export function useReorderPlaylistItems() {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      toast.error(`Échec du réordonnancement : ${error.message}`);
    },
  });
}

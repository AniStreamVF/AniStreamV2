...
export function useAddPlaylistComment() {
	...
	return useMutation({
		...
		onError: (error: any) => {
			toast.error(error?.message || 'Échec de la publication du commentaire');
		},
	});
}
...
export function useUpdatePlaylistComment() {
	...
	return useMutation({
		...
		onError: (error: any) => {
			toast.error(error?.message || 'Échec de la mise à jour du commentaire');
		},
	});
}
...
export function useDeletePlaylistComment() {
	...
	return useMutation({
		...
		onError: (error: any) => {
			toast.error(error?.message || "Échec de la suppression du commentaire");
		},
	});
}

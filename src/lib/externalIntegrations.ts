...
export function mapAniStreamStatusToAniList(status: string) {
...
export function mapAniListMangaStatusToAniStream(status: string) {
...
export function mapAniStreamMangaStatusToAniList(status: string) {
  const map: Record<string, any> = {
    'reading': 'CURRENT',
    'completed': 'COMPLETED',

...
export const DEVTOOLS_TRAP_STORAGE_KEY = "AniStream.devtools-trap-response";
export const DEVTOOLS_LOCK_STORAGE_KEY = "AniStream.devtools-trap-lock";
export const DEVTOOLS_LOCK_STORAGE_KEY_GLOBAL = "AniStream.devtools-trap-lock-global";

...
const combinedSourceCache = new Map<string, { expiresAt: number; data: StreamingData & { hasAniStreamAPI: boolean } }>();
...
export function setCachedCombinedSources(cacheKey: string, data: StreamingData & { hasAniStreamAPI: boolean }) {

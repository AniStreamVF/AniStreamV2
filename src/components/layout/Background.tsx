...
export function Background() {
  ...
  return (
    <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
      ...
      <div className="absolute top-[-20%] left-[-10%] w-[50vw] h-[50vw] rounded-full blur-[150px] animate-pulse-slow hidden md:block bg-white/5" />
      <div className="absolute bottom-[-20%] right-[-10%] w-[50vw] h-[50vw] rounded-full blur-[150px] animate-pulse-slow hidden md:block bg-white/5" style={{ animationDelay: "2s" }} />
    </div>
  );
}

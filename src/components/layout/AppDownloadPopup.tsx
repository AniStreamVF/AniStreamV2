...
export const AppDownloadPopup = () => {
    ...
    useEffect(() => {
        ...
        const hasSeen = localStorage.getItem('AniStream_app_promo_seen');
        if (!hasSeen) {
    ...
    const handleClose = () => {
        setIsOpen(false);
        localStorage.setItem('AniStream_app_promo_seen', 'true');
    };
                        ...
                        <GlassPanel className="overflow-hidden border-primary/30 shadow-2xl shadow-primary/20">
                            ...
                            <div className="grid md:grid-cols-2">
                                <div className="relative aspect-[4/5] md:aspect-auto bg-gradient-to-br from-primary/20 to-purple-500/20 p-8 flex flex-col justify-end">
                                    <div className="absolute inset-0 bg-[url('/AniStream-logo-square.png')] bg-center bg-no-repeat bg-contain opacity-10 scale-150 rotate-12" />
                                    <div className="relative space-y-2">
                                        <h2 className="text-3xl font-bold font-display">Améliorez votre expérience</h2>
                                        <p className="text-sm text-muted-foreground">
                                            Faites passer votre voyage anime au niveau supérieur avec nos applications natives.
                                        </p>
                                    </div>
                                </div>
                                    ...
                                    <div className="space-y-4">
                                        <div className="flex items-center gap-4 group cursor-pointer p-3 rounded-2xl hover:bg-primary/5 transition-colors border border-transparent hover:border-primary/20">
                                            ...
                                            <div className="flex-1">
                                                <h4 className="font-bold text-sm">Application mobile [En développement]</h4>
                                                <p className="text-xs text-muted-foreground">Regardez hors ligne sur Android et iOS</p>
                                            </div>
                                        ...
                                        <div className="flex items-center gap-4 group cursor-pointer p-3 rounded-2xl hover:bg-purple-500/5 transition-colors border border-transparent hover:border-purple-500/20">
                                            ...
                                            <div className="flex-1">
                                                <h4 className="font-bold text-sm">Application de bureau</h4>
                                                <p className="text-xs text-muted-foreground">Discord RPC et lecteur 4K natif</p>
                                            </div>
                                            <ChevronRight className="w-4 h-4 text-muted-foreground group-hover:translate-x-1 transition-transform" />
                                        </div>
                                    </div>

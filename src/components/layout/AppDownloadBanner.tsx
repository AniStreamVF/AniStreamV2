...
export function AppDownloadBanner() {
  ...
  const handleDownload = () => {
    window.open('https://github.com/YOUR_GITHUB_USERNAME/AniStream/releases/latest', '_blank');
  };
          ...
          <div className="flex items-start gap-3 mb-3">
            ...
            <div className="flex-1 pt-0.5">
              <h3 className="font-semibold text-sm mb-1">
                Téléchargez l'application AniStream
              </h3>
              <p className="text-xs text-muted-foreground leading-relaxed">
                Téléchargez pour le visionnage hors ligne, des performances accrues et des notifications de bureau
              </p>
            </div>
          </div>

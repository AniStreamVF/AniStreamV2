...
export function DownloadIndicator() {
  ...
  const openDownloadFolder = async () => {
    const downloadPath = localStorage.getItem('AniStream_download_path') || await (window as any).electron.getDownloadsDir();
    ...
    return (
      ...
      >
        ...
        >
          ...
          <span className="text-xs text-white/70">Téléchargements</span>
        </button>
      </motion.div>
    );
  }
      ...
      <div className="bg-zinc-900/95 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="flex items-center justify-between px-3 py-2.5 bg-gradient-to-r from-purple-500/5 to-pink-500/5 border-b border-white/10">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-medium text-white/80">Téléchargements</span>
            {totalActive > 0 && (

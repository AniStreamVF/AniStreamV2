      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="p-6 md:p-8 flex flex-col justify-center space-y-4 order-1 md:order-2">
          <div className="flex items-center gap-3 text-primary">
            ...
            <h2 className="text-2xl md:text-3xl font-display font-bold">Téléchargez notre application mobile</h2>
          </div>
          
          <p className="text-muted-foreground">
            Nous développons les prochaines applications AniStream...
          </p>

          <div className="space-y-2 py-4">
            <div className="flex items-center gap-2 text-sm">
              <div className="w-2 h-2 rounded-full bg-primary"></div>
              <span>Versions de bureau en cours : Windows, Linux et macOS</span>
            </div>
            <div className="flex items-center gap-2 text-sm">
              <div className="w-2 h-2 rounded-full bg-primary"></div>
              <span>Livraison assistée P2P pour une lecture plus fluide sur les réseaux faibles</span>
            </div>
            <div className="flex items-center gap-2 text-sm">
              <div className="w-2 h-2 rounded-full bg-primary"></div>
              <span>Téléchargements hors ligne, alertes et synchronisation fluide entre appareils</span>
            </div>
          </div>

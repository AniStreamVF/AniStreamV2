...
const PROMPT_KEY = 'AniStream_reduce_motion_prompt_seen';
const REDUCE_MOTION_KEY = 'AniStream_reduce_motion';
const REDUCE_MOTION_DELAY_UNTIL_KEY = 'AniStream_reduce_motion_prompt_delay_until';
const V5_ANNOUNCEMENT_SEEN_KEY = 'AniStream_v5_announced';
  ...
  const applyReduceMotion = (enabled: boolean) => {
    ...
    try {
      ...
      if (saved) {
        ...
        localStorage.setItem('AniStream_mobile_config', JSON.stringify(cfg));
      }
    } catch (e) {
      /* ignore JSON errors */
    }
        ...
        <div className="relative p-4">
          ...
          <div className="flex items-start gap-3 mb-3 pr-6">
            ...
            <div className="flex-1 pt-0.5">
              <h3 className="font-semibold text-sm mb-1">Réduire les effets de mouvement ?</h3>

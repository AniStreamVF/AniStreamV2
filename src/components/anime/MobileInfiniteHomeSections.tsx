    ...
    <section className="mt-12 pb-28">
      <div className="mb-6 px-2">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="font-display text-3xl font-black tracking-tight text-white">Découvrir plus</h2>
            <p className="text-sm text-muted-foreground">Flux mobile de sélections d'anime infinies</p>
          </div>
        </div>
      </div>
      ...
      {error && (
        <div className="px-2">
          <GlassPanel className="border-red-500/30 bg-red-500/10 p-5 text-center">
            <p className="mb-3 text-sm font-semibold text-white">Échec du chargement du flux de découverte</p>
            <Button
              onClick={() => {
      ...
      {!isLoading && visibleSections.length === 0 && !error && (
        <div className="px-2">
          <GlassPanel className="p-5 text-center">
            <p className="mb-3 text-sm text-muted-foreground">Aucune carte de découverte disponible</p>
            <Button

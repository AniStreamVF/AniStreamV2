...
export const SeasonDownloadModal = ({ isOpen, onClose, episodes, animeName, posterUrl }: SeasonDownloadModalProps) => {
    ...
    useEffect(() => {
        if (isOpen && !isNative) {
            toast.error("Les téléchargements sont disponibles uniquement dans l'application native mobile ou de bureau", {
                description: "Veuillez télécharger notre application pour utiliser les fonctionnalités de téléchargement hors ligne"
            });
            onClose();
        }
                ...
                <GlassPanel className="p-4 sm:p-6 space-y-4 sm:space-y-6 max-h-[90vh] overflow-y-auto">
                    <div className="flex items-center justify-between">
                        <h2 className="text-xl sm:text-2xl font-bold flex items-center gap-2">
                            ...
                            <span className="hidden sm:inline">Télécharger les épisodes</span>

  ...
  return (
    ...
    >
      ...
      <p className="text-xs text-muted-foreground">
        {playlist.items_count} {playlist.items_count === 1 ? 'élément' : 'éléments'}
      </p>
    </motion.div>
  );
}
      ...
      {playlists.length > 0 ? (
        ...
        <div className="flex items-center gap-6 p-6 rounded-2xl bg-muted/30 border border-white/5">
          ...
          <div className="flex-1">
            <h3 className="font-semibold mb-1">Créez votre première playlist</h3>
            <p className="text-sm text-muted-foreground mb-3">
              Organisez vos animes préférés en playlists
            </p>

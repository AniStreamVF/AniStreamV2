...
function CommentItem({ comment, animeId, episodeId, isReply = false }: CommentItemProps) {
  ...
  const handleBanUser = async () => {
    ...
    try {
      ...
      toast.error('Échec du bannissement de l\'utilisateur : ' + error.message);
    } finally {
      setIsBanning(false);
    }
  };
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-48">
                  ...
                  >
                    ...
                    {comment.is_pinned ? 'Désépingler le commentaire' : 'Épingler le commentaire'}
                  </DropdownMenuItem>
    ...
    <div className="space-y-6">
      ...
      {user ? (
        ...
        <div className="p-4 rounded-xl bg-card/50 border border-border/30 text-center">
          <p className="text-muted-foreground mb-3">Connectez-vous pour participer à la discussion</p>

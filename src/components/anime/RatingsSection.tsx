  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-2">
        ...
        <h3 className="font-display text-xl font-semibold">Notes et avis</h3>
      </div>
      ...
      <div className="flex items-center gap-6 p-4 rounded-xl bg-card/50 border border-border/30">
        {loadingStats ? (
          ...
          <div className="text-muted-foreground">Aucune note pour le moment. Soyez le premier !</div>
        )}
      </div>
      ...
      {user ? (
        <div className="p-4 rounded-xl bg-card/50 border border-border/30">
          {loadingUserRating ? (
            ...
            <div className="space-y-4">
              <p className="text-sm text-muted-foreground">Noter cet anime</p>
              <StarRating
                rating={selectedRating}
                onRate={handleRate}
                interactive
              ...
              {showReviewInput && (
                <div className="space-y-3 mt-4 pt-4 border-t border-border/30">
                  <Textarea
                    ...
                    placeholder="Écrire un avis (optionnel)..."
        ...
        <div className="p-4 rounded-xl bg-card/50 border border-border/30 text-center">
          <p className="text-muted-foreground mb-3">Connectez-vous pour noter cet anime</p>

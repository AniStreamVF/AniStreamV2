          ...
          <div className="flex items-center gap-5">
            ...
            <div>
              ...
              <p className="text-muted-foreground font-medium text-lg">
                Explorez une bibliothèque infinie de chefs-d'œuvre anime
              </p>
            </div>
          </div>
        </div>
      ...
      {hasQueryError && (
        <div className="mb-16 px-2">
          <GlassPanel className="p-8 text-center border-red-500/30 bg-red-500/10">
            <p className="text-lg font-bold text-foreground mb-2">Impossible de charger les sections de découverte</p>
            <p className="text-sm text-muted-foreground mb-5">
              La requête a échoué sur ce réseau. Appuyez sur Réessayer.
            </p>
            <Button
              onClick={() => {
              ...
              <GlassPanel className="p-10 relative overflow-hidden bg-gradient-to-br from-primary/20 via-background to-purple-500/10 border-primary/20 group">
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                  <div className="text-center md:text-left">
                    <h3 className="text-2xl md:text-3xl font-black mb-3">AniStream est meilleur avec votre voix</h3>
                    <p className="text-muted-foreground max-w-lg">Une fonctionnalité en tête ? Vous voulez voir un anime spécifique ? Notre communauté façonne l'avenir d'AniStream.</p>
                  </div>
                  <Button
      ...
      {!hasQueryError && !isLoading && !isFetchingNextPage && visibleSections.length === 0 && (
        <div className="mb-16 px-2">
          <GlassPanel className="p-8 text-center border-white/10 bg-white/5">
            <p className="text-lg font-bold text-foreground mb-2">Le flux de découverte charge encore</p>
            <p className="text-sm text-muted-foreground mb-5">
              Votre connexion ou les fournisseurs ont retardé le chargement. Appuyez sur Réessayer.
            </p>
            <Button
              onClick={() => {
          ...
          <div className="relative inline-block px-12 py-3 bg-card/40 backdrop-blur-xl border border-white/5 rounded-full overflow-hidden">
            <div className="flex items-center gap-3">
              ...
              <p className="font-display font-medium tracking-tight text-muted-foreground group-hover:text-foreground transition-colors">
                Vous avez atteint la fin du multivers
              </p>
            </div>
          </div>
        </div>

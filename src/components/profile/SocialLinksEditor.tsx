...
export function SocialLinksEditor({ 
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      toast.success('Paramètres du profil enregistrés !');
      setOpen(false);
    } catch (error: any) {
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Permettre aux autres de voir votre profil via @pseudo</p>
                </div>
                <Switch
                ...
                >
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">Afficher votre liste de suivi publiquement</p>
                    </div>
                    <Switch
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">Afficher votre historique de visionnage publiquement</p>
                    </div>
                    <Switch

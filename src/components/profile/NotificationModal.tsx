        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-xl p-0 overflow-hidden bg-background/80 backdrop-blur-xl border-white/5">
                ...
                <ScrollArea className="max-h-[70vh]">
                    {isLoading ? (
                        <div className="flex flex-col items-center justify-center py-20 gap-3">
                            ...
                            <p className="text-xs text-muted-foreground font-medium uppercase tracking-widest">Chargement de la transmission...</p>
                        </div>
                    ) : notifications.length === 0 ? (
                        <div className="flex flex-col items-center justify-center py-20 px-10 text-center">
                            ...
                            <h3 className="text-lg font-bold mb-1">Le silence est d'or</h3>
                            <p className="text-muted-foreground text-sm max-w-xs">Vous n'avez aucune nouvelle notification. Nous vous préviendrons quand quelque chose d'intéressant se produira !</p>
                        </div>
                    ) : (
                ...
                <div className="p-4 border-t border-white/5 bg-black/20 flex justify-center">
                    <p className="text-[10px] text-muted-foreground font-black uppercase tracking-[0.2em]">Protocole de transmission actif</p>
                </div>
            </DialogContent>
        </Dialog>
    );

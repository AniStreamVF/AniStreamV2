      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        ...
        <GlassPanel className={cn(
          ...
          <div className="flex flex-col items-center gap-1">
            ...
            <div className="text-xs text-muted-foreground font-medium">Série de jours</div>
            {streak.isActiveToday && (
              <div className="text-[10px] text-orange-400 font-semibold">Actif aujourd'hui !</div>
            )}
          </div>
        </GlassPanel>
        ...
        <GlassPanel className="p-4 text-center">
          <div className="flex flex-col items-center gap-1">
            ...
            <div className="text-xs text-muted-foreground font-medium">Meilleure série</div>
          </div>
        </GlassPanel>
        ...
        <GlassPanel className="p-4 text-center">
          <div className="flex flex-col items-center gap-1">
            ...
            <div className="text-xs text-muted-foreground font-medium">Épisodes</div>
          </div>
        </GlassPanel>
        ...
        <GlassPanel className="p-4 text-center">
          <div className="flex flex-col items-center gap-1">
            ...
            <div className="text-xs text-muted-foreground font-medium">Heures</div>
          </div>
        </GlassPanel>
      </div>
      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-display text-base font-bold">Succès</h3>

                ...
                <DialogHeader className="p-6 pb-0">
                    <div className="flex items-center justify-between gap-4 mb-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <DialogTitle className="text-xl font-bold">Marketplace communautaire</DialogTitle>
                                <DialogDescription className="text-xs">
                                    Liens communautaires approuvés pour {animeName} ép.{episodeNumber}
                                </DialogDescription>
                            </div>
                        </div>
                        <Button
                    ...
                    <div className="relative mb-6">
                        ...
                        <Input
                            placeholder="Rechercher par contributeur ou fournisseur..."
                ...
                <div className="flex-1 overflow-y-auto p-6 pt-0 space-y-3 custom-scrollbar">
                    {filteredSources.length > 0 ? (
                        ...
                        <div className="py-12 text-center border border-dashed border-white/5 rounded-2xl bg-white/5">
                            ...
                            <p className="text-sm font-medium text-muted-foreground">Aucune source trouvée pour "{searchQuery}"</p>
                            <p className="text-[10px] text-muted-foreground mt-1">Essayez un autre terme de recherche ou partagez un nouveau lien !</p>
                        </div>
                    )}
                </div>
            </DialogContent>

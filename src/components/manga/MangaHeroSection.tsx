      ...
      <div className="lg:hidden relative">
        ...
        >
            ...
            <div className="flex-1 min-w-0 py-2">
              ...
              <div className="text-xs text-muted-foreground">
                ...
                {activeSpotlight.chapters
                  ? `${activeSpotlight.chapters} Chapitres`
                  : activeSpotlight.status || "En cours"}
              </div>
            </div>
          </div>
          ...
          <div className="flex gap-3">
            <button
              onClick={handleRead}
              className="flex-1 h-12 rounded-full bg-primary text-primary-foreground font-bold text-sm hover:scale-[1.02] active:scale-95 transition-all flex items-center justify-center gap-2 shadow-lg"
            >
      ...
      <div className="hidden lg:grid grid-cols-12 gap-8 items-center">
        ...
        >
          ...
          <div className="flex items-center gap-4 pt-4">
            <button
              onClick={handleRead}
              className="h-14 px-8 rounded-full bg-primary text-primary-foreground font-bold text-lg hover:scale-105 active:scale-95 transition-all flex items-center gap-2 glow-primary"
            >
              <BookOpen className="w-5 h-5 fill-primary-foreground" />
              Lire
            </button>
          </div>

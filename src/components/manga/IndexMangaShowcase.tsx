  ...
  return (
    <section className="mb-12">
      <div className="mb-4 flex items-end justify-between gap-3">
        <div>
          <h2 className="text-xl md:text-2xl font-black flex items-center gap-2">
            ...
            Sélection manga du soir
          </h2>
          <p className="text-sm text-muted-foreground mt-1">
            Bannière en avant + cartes manga rapides à ouvrir et lire immédiatement.
          </p>
        </div>
        <Link
          to="/manga"
      ...
      {/* <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
        <GlassPanel className="p-5 border border-primary/25 bg-primary/10">
          <div className="flex items-start justify-between gap-4">
            <div>
              <p className="text-[11px] uppercase tracking-wider font-bold text-primary">Lecture rapide</p>
              <h3 className="mt-2 text-lg font-black">Passez de la carte au chapitre en quelques secondes</h3>
        ...
        <GlassPanel className="p-5 border border-white/10">
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <h3 className="mt-2 text-lg font-black">Filtres puissants dans la recherche unifiée</h3>
              <p className="mt-2 text-sm text-muted-foreground">
      ...
      {isLoading ? (
        ...
        <GlassPanel className="p-5 border border-white/10">
          <p className="text-sm text-muted-foreground">Les cartes manga chargent. Revenez bientôt.</p>
        </GlassPanel>
      )}
    </section>
  );

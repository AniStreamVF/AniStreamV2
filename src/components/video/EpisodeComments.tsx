...
export function EpisodeComments({ animeId, episodeId, animeName }: EpisodeCommentsProps) {
  ...
  const handleLike = async (id: string, currentlyLiked: boolean) => {
    if (!user) { toast.error('Connectez-vous pour aimer les commentaires'); return; }
          ...
          >
            ...
            <GlassPanel className="p-4 mb-6">
              <div className="flex gap-3">
                ...
                <div className="flex-1 space-y-2">
                  <Textarea
                    placeholder={user ? (episodeId ? `Partagez votre avis sur cet épisode…` : `Partagez votre avis sur cet anime…`) : 'Connectez-vous pour commenter'}
                    value={newComment}
            ...
            {isLoading ? (
              ...
              <div className="flex flex-col items-center justify-center py-16 text-center">
                ...
                <p className="font-medium text-muted-foreground">Aucun commentaire</p>

                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-lg text-muted-foreground font-medium">Regarder ensemble</span>
                            {liveRooms.length > 0 && (
                                <span className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-red-500/10 border border-red-500/20">
                                    <Radio className="w-3 h-3 text-red-500 animate-pulse" />
                                    <span className="text-xs font-bold text-red-400">{liveRooms.length} EN DIRECT</span>
                                </span>
                            )}
                        </div>
                        <p className="text-sm text-muted-foreground">Rejoignez une salle et regardez des animes avec d'autres</p>
                    </div>
                </div>
                <Link to="/isshoni">
                    ...
                    <GlassPanel className="p-5 bg-gradient-to-r from-pink-500/5 via-purple-500/5 to-indigo-500/5 border-primary/10 hover:border-primary/30 transition-all group cursor-pointer">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <p className="font-bold group-hover:text-primary transition-colors">Lancer une session</p>
                                    <p className="text-sm text-muted-foreground">Créez une salle et invitez des amis à regarder ensemble</p>
                                </div>
                            </div>

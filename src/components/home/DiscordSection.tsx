      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="p-6 md:p-8 flex flex-col justify-center space-y-4">
          <div className="flex items-center gap-3 text-[#5865F2]">
            ...
            <h2 className="text-2xl md:text-3xl font-display font-bold">Rejoignez notre Discord</h2>
          </div>
          
          <p className="text-muted-foreground">
            Connectez-vous avec des milliers de fans d'anime, recevez des mises à jour, participez à des événements et discutez de vos séries préférées !
          </p>
          ...
          <Button
            onClick={() => window.open('https://dsc.gg/AniStream', '_blank')}
          ...
          <p className="text-xs text-muted-foreground">
            Obtenez des rôles exclusifs, un accès anticipé aux fonctionnalités et un support direct !
          </p>
        </div>

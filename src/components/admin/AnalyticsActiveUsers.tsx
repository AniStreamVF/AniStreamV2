        ...
        <div className="space-y-8">
                ...
                <GlassPanel className="p-6 border-primary/20 bg-primary/5">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-xs font-bold uppercase tracking-widest text-muted-foreground">Membres actifs</p>
                        </div>
                    </div>
                </GlassPanel>
                ...
                <GlassPanel className="p-6 border-white/10 bg-white/5">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-xs font-bold uppercase tracking-widest text-muted-foreground">Sessions invitées</p>
                        </div>
                    </div>
                </GlassPanel>
            </div>
            ...
            <GlassPanel className="p-6">
                <h3 className="text-lg font-bold mb-6 flex items-center gap-2">
                    ...
                    Activité des utilisateurs en direct
                </h3>
                ...
                {loadingUsers ? (
                    ...
                    <div className="py-10 text-center border-2 border-dashed border-white/5 rounded-3xl">
                        <p className="text-muted-foreground text-sm">Aucun utilisateur enregistré actif.</p>
                    </div>
                )}
            </GlassPanel>
        </div>

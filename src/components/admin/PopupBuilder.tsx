...
export function PopupBuilder() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      toast.error('Échec de la sauvegarde de la popup');
    }
  };
  ...
  const handleDelete = async (id: string) => {
    ...
    try {
      ...
      toast.error('Échec de la suppression de la popup');
    }
  };
  ...
  const handleToggleActive = async (popup: Popup) => {
    try {
      ...
      toast.success(popup.is_active ? 'Popup désactivée' : 'Popup activée');
    } catch (error) {
      toast.error('Échec de la mise à jour de la popup');
    }
  };
    ...
    <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-3 gap-4">
                <div>
                  <label className="text-sm font-medium mb-2 block">Arrière-plan</label>
      ...
      {isLoading ? (
        ...
        <div className="text-center py-12">
          ...
          <p className="text-muted-foreground">Aucune popup créée pour le moment</p>
        </div>
      ) : (

            ...
            <TabsContent value="comments" className="mt-0">
                <div className="space-y-3">
                    {loadingComments ? (
                        ...
                        <div className="py-8 text-center text-muted-foreground">Aucun commentaire récent</div>
                    ) : (
            ...
            <TabsContent value="posts" className="mt-0">
                <div className="space-y-3">
                    {loadingPosts ? (
                        ...
                        <div className="py-8 text-center text-muted-foreground">Aucune publication récente</div>
                    ) : (
                        posts?.map((post: any) => (
            ...
            <TabsContent value="tierlists" className="mt-0">
                <div className="space-y-3">
                    {loadingTierLists ? (
                        ...
                        <div className="py-8 text-center text-muted-foreground">Aucun classement</div>
                    ) : (
            ...
            <TabsContent value="playlists" className="mt-0">
                <div className="space-y-3">
                    {loadingPlaylists ? (
                        ...
                        <div className="py-8 text-center text-muted-foreground">Aucune playlist</div>
                    ) : (

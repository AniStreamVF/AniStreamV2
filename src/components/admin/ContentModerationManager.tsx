...
export function ContentModerationManager() {
  ...
  const deleteForumPost = useMutation({
    ...
    onSuccess: () => {
      ...
      toast.success('Publication du forum supprimée');
    },
    onError: () => {
      toast.error('Échec de la suppression de la publication');
    },
  });
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-4 mt-2 text-xs text-muted-foreground">
                        <span>Par @{post.profile?.username || 'unknown'}</span>
                    ...
                    <div className="flex items-center gap-2">
                      <Button
                        ...
                        onClick={async () => {
                          try {
                            ...
                            toast.success(post.is_pinned ? 'Publication désépinglée' : 'Publication épinglée');
                          } catch (e) {
                            toast.error('Échec de la mise à jour du statut d\'épingle');
                          }
                        }}
                      ...
                      <Button
                        ...
                        size="sm"
                        onClick={() => {
                          if (confirm('Supprimer cette publication forum ?')) {
                ...
                >
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-muted-foreground line-clamp-1 mt-1">
                        {tierList.description || 'Aucune description'}
                      </p>
                      <div className="flex items-center gap-4 mt-2 text-xs text-muted-foreground">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Button
                        ...
                        size="sm"
                        onClick={() => {
                          if (confirm('Supprimer ce classement ?')) {

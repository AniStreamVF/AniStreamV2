...
export function AppVersionManager() {
    ...
    const handleForceUpdate = () => {
        if (confirm(`Êtes-vous sûr de vouloir forcer tous les utilisateurs à mettre à jour vers la version ${__APP_VERSION__} ? Cela définira la version minimale prise en charge à ${__APP_VERSION__}.`)) {
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="font-display text-lg font-semibold">Mises à jour de l'application mobile</h3>
            </div>
                ...
                <div className="space-y-4">
                    <div className="p-4 rounded-xl bg-muted/20 border border-white/5 space-y-4">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="grid gap-2">
                                <Label htmlFor="update_message">Message de mise à jour</Label>
                                <div className="flex gap-2">
                                    <Input
                                        id="update_message"
                                        value={updateMessage}

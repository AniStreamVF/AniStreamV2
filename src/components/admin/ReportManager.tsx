...
export function ReportManager() {
    ...
    const updateReportStatus = useMutation({
        ...
        onError: (error: any) => {
            toast.error("Échec de la mise à jour du signalement : " + error.message);
        }
    });
        ...
        <div className="space-y-6">
            ...
            {isLoading ? (
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center gap-2 text-xs text-muted-foreground font-medium">
                                            <span>Signalé par {report.reporter?.display_name || "Inconnu"}</span>
                                            <span>•</span>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div>
                                            ...
                                            <div className="p-4 rounded-xl bg-orange-500/5 border border-orange-500/20 text-sm">
                                                {report.details || "Aucun contexte supplémentaire fourni."}
                                            </div>
                                        </div>
                                        <div>
                ...
                <GlassPanel className="p-20 text-center border-dashed border-white/5">
                    ...
                    <p className="text-muted-foreground font-medium">Aucun signalement trouvé pour cette catégorie.</p>
                </GlassPanel>
            )}
        </div>
    );

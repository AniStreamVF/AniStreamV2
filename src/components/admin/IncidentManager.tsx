  ...
  const handleStatusUpdate = async (incident: StatusIncident, newStatus: StatusIncident['status']) => {
    try {
      await updateIncident.mutateAsync({
        ...
        updateMessage: updateMessage || `Statut changé en ${newStatus}`,
      });
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h2 className="font-display text-xl font-semibold flex items-center gap-2">
          ...
          Incidents de la page de statut
        </h2>
...
Nouvel incident
      ...
      {showForm && (
        <div className="p-6 rounded-xl bg-muted/30 border border-muted space-y-4">
          <div className="flex items-center justify-between">
            <h3 className="font-medium">Nouvel incident</h3>
          ...
          <div className="space-y-4">
            <div>
              ...
              <Input
                ...
                placeholder="ex. Performance de streaming dégradée"
            ...
            <div>
              <label className="text-sm font-medium mb-2 block">Services affectés</label>
                ...
                <div className="mt-4 pt-4 border-t border-muted space-y-4">
                  ...
                  {incident.updates && incident.updates.length > 0 && (
                    <div className="space-y-2">
                      <h4 className="text-sm font-medium">Mises à jour</h4>

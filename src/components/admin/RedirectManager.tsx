...
export function RedirectManager() {
    ...
    const createRedirect = useMutation({
        ...
        onError: (error: any) => {
            toast.error('Échec de la création de la redirection : ' + error.message);
        }
    });
        ...
        <div className="space-y-6">
            ...
            {isAdding && (
                <GlassPanel className="p-4 border-primary/20 bg-primary/5">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            <label className="text-xs font-bold uppercase tracking-wider text-muted-foreground mb-1 block">Slug (ex. discord)</label>
                        ...
                        <div>
                            <label className="text-xs font-bold uppercase tracking-wider text-muted-foreground mb-1 block">URL cible</label>
                            <Input
            ...
            <div className="grid gap-3">
                {isLoading ? (
                    ...
                    <p className="text-center py-10 text-muted-foreground">Aucune redirection configurée</p>
                ) : (
                    redirects?.map((r) => (
                            ...
                            <div className="flex items-center justify-between gap-4">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <Button
                                        ...
                                        onClick={() => {
                                            if (confirm('Supprimer cette redirection ?')) deleteRedirect.mutate(r.id);
                                        }}
                                    >

...
export function AnalyticsDashboard() {
  ...
  const statCards = [
    ...
    },
    {
      ...
      subtitle: `${topCountries?.[0]?.value || 0} visiteurs`,
        ...
        <GlassPanel className="p-6">
          ...
          <div className="h-64 flex items-center">
            {topGenres && topGenres.length > 0 ? (
              ...
              <div className="w-full text-center text-muted-foreground">Aucune donnée de genre pour le moment</div>
            )}
          </div>
        </GlassPanel>
      </div>
              ...
              {topCountries.map((country, index) => (
                <div key={country.name} className="flex items-center gap-3">
                  ...
                  <span className="text-sm text-muted-foreground w-20 text-right">
                    {country.value} visiteurs
                  </span>
                </div>
              ))}
            </div>
          ) : (
            <div className="text-center py-8 text-muted-foreground">Aucune donnée de pays pour le moment</div>
          )}
        </GlassPanel>
        ...
        <GlassPanel className="p-6">
          ...
          <div className="h-48 flex items-center">
            {referrerChannels && referrerChannels.length > 0 ? (
              ...
              <div className="text-center w-full text-muted-foreground">Aucune donnée d'acquisition pour le moment</div>
            )}
          </div>
        </GlassPanel>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={hourlyActivity || []}>
                ...
                />
                <Bar dataKey="visits" fill="hsl(var(--primary))" radius={[6, 6, 0, 0]} name="Visites" />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </GlassPanel>
        ...
        <GlassPanel className="p-6">
          ...
          {topPages && topPages.length > 0 ? (
            ...
            <div className="h-64 flex items-center justify-center text-muted-foreground">Aucune donnée de page pour le moment</div>
          )}
        </GlassPanel>
      </div>

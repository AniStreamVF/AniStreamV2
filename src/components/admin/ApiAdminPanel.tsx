...
import { AniStream_API_URL, unwrapApiData } from '@/lib/api/api-client';
...
const fetchJson = async <T,>(path: string, init?: RequestInit, timeoutMs = 12000): Promise<T> => {
  ...
  try {
    ...
    const response = await fetch(`${AniStream_API_URL}${path}`, {
      ...init,
...
export function ApiAdminPanel() {
  ...
  const [webhookMessage, setWebhookMessage] = useState('AniStream API admin test message');
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
        <GlassPanel className="p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs text-muted-foreground">Scrapers opérationnels</p>
        ...
        <GlassPanel className="p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs text-muted-foreground">Instantanés canoniques</p>
              <p className="text-xl font-bold">
        ...
        <GlassPanel className="p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs text-muted-foreground">File d'attente source</p>
              <p className="text-xl font-bold">
      ...
      <GlassPanel className="p-6">
        <div className="flex items-start justify-between gap-3 mb-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Live health from {AniStream_API_URL}/health/scrapers
            </p>
          </div>
          <div className="flex items-center gap-2">
            <a
              href={`${AniStream_API_URL}/health/scrapers`}
              target="_blank"
              rel="noreferrer"
        ...
        {scraperHealthQuery.isLoading ? (
          <p className="text-sm text-muted-foreground">Chargement de la santé des scrapers...</p>
        ) : scraperHealthQuery.isError ? (
          <p className="text-sm text-destructive">Échec du chargement.</p>
        ) : (
      ...
      <GlassPanel className="p-6">
        ...
        {!canonicalData?.enabled ? (
          ...
          <p className="text-sm text-muted-foreground">Chargement du résumé canonique...</p>
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 md:grid-cols-5 gap-2">
              ...
              <div className="rounded-lg border border-border/40 p-3">
                <p className="text-xs text-muted-foreground">File totale</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              <div className="rounded-lg border border-border/40 p-3">
                <p className="font-medium mb-2">Instantané par portée</p>
                <div className="space-y-2">
              ...
              <div className="rounded-lg border border-border/40 p-3">
                <p className="font-medium mb-2">Tâches récentes</p>
          ...
          <p className="text-sm text-muted-foreground">Aucun résumé canonique disponible.</p>
        )}
      </GlassPanel>
      ...
      <GlassPanel className="p-6">
        <div className="mb-4">
          <h2 className="font-display text-xl font-semibold flex items-center gap-2">
            ...
            Test de vérification du webhook API
          </h2>
          <p className="text-sm text-muted-foreground mt-1">
            Envoie un test au webhook Discord via le canal de statut.
          </p>
        </div>

...
export function MarketplaceManager() {
    ...
    const updateItemStatus = useMutation({
        ...
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: ['admin_marketplace_items'] });
            toast.success("Statut de l'élément mis à jour");
        }
    });
        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <h2 className="text-xl font-bold flex items-center gap-2">
                        ...
                        Soumissions de langue
                    </h2>
                    <p className="text-xs text-muted-foreground mt-1 text-balance">Examiner les sous-titres et sources soumis</p>
                </div>
            ...
            {isLoading ? (
                            ...
                            <div className="flex items-start justify-between gap-4">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-muted-foreground mb-3 italic">Téléchargé par {item.user?.display_name || "Utilisateur inconnu"}</p>
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <Button
                                        ...
                                        onClick={() => {
                                            if (confirm("Êtes-vous sûr de vouloir supprimer définitivement cette soumission ?")) {
                ...
                <GlassPanel className="p-20 text-center border-dashed border-white/5">
                    ...
                    <p className="text-muted-foreground font-medium text-sm">Aucun élément en attente.</p>
                </GlassPanel>
            )}
        </div>
    );

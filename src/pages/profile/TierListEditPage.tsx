...
export default function TierListEditPage() {
    ...
    const canEdit = isOwner || !!tierListAccess?.canEdit;

    if (isLoading || (tierList && loadingAccess)) {
        return (
        ...
        return (
            <div className="min-h-screen bg-background flex items-center justify-center">
                <div className="text-center">
                    <p className="text-muted-foreground mb-4">Classement introuvable</p>
                    <button
    ...
    if (!canEdit) {
        return (
            <div className="min-h-screen bg-background flex items-center justify-center">
                <div className="text-center">
                    <p className="text-muted-foreground mb-4">Vous n'avez pas la permission de modifier ce classement</p>
                    <button
                        onClick={() => navigate('/tierlists')}
                        className="text-primary hover:underline"
                    >
        ...
        <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
            ...
            <main className="relative z-10 pl-6 md:pl-32 pr-6 py-6 max-w-[1400px] mx-auto pb-24 md:pb-6">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-muted-foreground">Mettez à jour votre classement</p>
                </div>

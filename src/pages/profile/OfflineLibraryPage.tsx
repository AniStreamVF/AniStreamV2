...
export default function OfflineLibraryPage() {
    ...
    const getDownloadPath = () => {
        return localStorage.getItem('AniStream_download_path') || null;
    };
    ...
    const handleSyncLibrary = async () => {
        ...
        try {
            ...
            toast.error('Échec de la synchronisation de la bibliothèque');
        } finally {
            setSyncing(false);
        }
    };
    ...
    const handleImportVideos = async () => {
        ...
        try {
            ...
            toast.error('Échec de l\'importation des vidéos');
        }
    };
    ...
    const handleRepairAnime = async (anime: OfflineAnime, e: React.MouseEvent) => {
        ...
        try {
            toast.info(`Réparation de ${anime.name}...`);
            ...
            if (result.success) {
                ...
                toast.error(result.error || 'Échec de la réparation');
            }
        } catch (err) {
            console.error('Repair failed:', err);
            toast.error('Échec de la réparation de l\'anime');
        }
    };
    ...
    const handleDeleteAnime = async (anime: OfflineAnime, e: React.MouseEvent) => {
        ...
        try {
            toast.loading(`Suppression de ${anime.name}...`);
            ...
            if (result.success) {
                ...
                toast.error(result.error || 'Échec de la suppression de l\'anime');
            }
        } catch (err) {
            console.error('Delete failed:', err);
            toast.error('Échec de la suppression de l\'anime');
        }
    };
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-background text-foreground p-6 text-center">
                <GlassPanel className="p-12 space-y-6 max-w-md">
                    ...
                    <h1 className="text-3xl font-bold">Fonctionnalité native</h1>
                    <p className="text-muted-foreground">
                        The offline library is only available in the AniStream Desktop and Mobile apps.
                    </p>
            ...
            <main className={isNative ? "pl-6 pr-6 py-12 max-w-[1600px] mx-auto space-y-8" : "pl-6 md:pl-32 pr-6 py-12 max-w-[1600px] mx-auto space-y-8"}>
                ...
                <div className="flex flex-col gap-6">
                    <div className="flex flex-col md:flex-row md:items-start justify-between gap-6">
                        <div className="space-y-2">
                            <h1 className="text-4xl md:text-5xl font-bold font-display tracking-tight">Bibliothèque hors ligne</h1>
                            <p className="text-muted-foreground">Continuez votre voyage sans connexion internet.</p>
                        </div>
                                ...
                                <GlassPanel key={episodeId} className="p-4 space-y-3">
                                    ...
                                    <div className="space-y-1.5">
                                        ...
                                        <div className="flex items-center justify-between text-[10px] text-muted-foreground">
                                            <span>{state.status === 'queued' ? 'En attente' : `${state.progress?.toFixed(0) || 0}%`}</span>
                ...
                {loading ? (
                            ...
                            >
                                <div className="aspect-[3/4] relative overflow-hidden bg-gradient-to-br from-purple-500/20 to-blue-500/20">
                                    ...
                                    <button
                                        ...
                                        title="Réparer - Re-télécharger l'affiche et les sous-titres manquants"
                                    >
                                    ...
                                    <button
                                        ...
                                        title="Supprimer l'anime et tous les épisodes"
                                    >
                                ...
                                <div className="p-4 space-y-1">
                                    ...
                                    <div className="flex items-center justify-between">
                                        ...
                                        {!anime.poster && (
                                            <span className="text-[10px] text-amber-500 font-medium">Affiche manquante</span>
                                        )}
                                    </div>
                                </div>
                            </GlassPanel>
                    ...
                    <div className="flex flex-col items-center justify-center py-32 text-center space-y-6">
                        ...
                        <div className="space-y-2">
                            <h2 className="text-2xl font-bold">La bibliothèque est vide</h2>
                        ...
                        <div className="mt-8 p-4 rounded-xl bg-white/5 border border-white/10 max-w-lg text-left">
                            ...
                            <ul className="text-xs text-muted-foreground space-y-1.5">
                                ...
                                <li>• <strong>Sync Folder:</strong> Put video files in the AniStream folder and click Sync</li>

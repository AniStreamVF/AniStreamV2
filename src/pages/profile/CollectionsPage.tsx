...
const TABS: { id: TabType; icon: any; label: string; isJikan?: boolean }[] = [
  { id: "popular", icon: Flame, label: "Populaire" },
  { id: "favorites", icon: Heart, label: "Favoris" },
  { id: "airing", icon: Star, label: "En diffusion" },
  { id: "completed", icon: Clock, label: "En complétion" },
  { id: "season-now", icon: Calendar, label: "De la saison", isJikan: true },
  { id: "upcoming", icon: Sparkles, label: "À venir", isJikan: true },
];
      ...
      <div className="absolute inset-x-0 bottom-0 p-4 md:p-8 lg:p-12 flex flex-col justify-end max-w-3xl">
        ...
        <div className="flex items-center gap-4">
          ...
          >
            ...
            {anime.id.startsWith('mal-') ? 'Voir sur MAL' : 'Regarder'}
          </button>
          <button
            onClick={handleClick}
...
export default function CollectionsPage() {
  ...
  const collectionTitle = useMemo(() => {
    switch (activeTab) {
      case 'popular': return "Les plus populaires";
      case 'favorites': return "Favoris des fans";
      case 'airing': return "Meilleurs en cours";
      case 'completed': return "Viennent de se terminer";
      case 'season-now': return "De la saison";
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm md:text-base font-medium">
                  Explorez des bibliothèques de chefs-d'œuvre
                </p>
              </div>
            </div>

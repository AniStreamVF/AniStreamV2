    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-4">
        <GlassPanel className="p-8 text-center max-w-md">
          ...
          <h2 className="text-xl font-bold mb-2">Mobile uniquement</h2>
          <p className="text-muted-foreground mb-4">Les téléchargements sont disponibles uniquement dans l'application mobile.</p>
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="pb-28 pt-4">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="mb-6">
            ...
            <p className="text-muted-foreground text-sm">Regarder hors ligne</p>
          </div>
            ...
            <GlassPanel className="p-4 mb-6 border-primary/30 bg-primary/5">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium">
                  {activeDownloads.length} téléchargement...
                </span>
              </div>
            </GlassPanel>
          )}
          ...
          {loading ? (
            ...
            <GlassPanel className="p-12 text-center">
              ...
              <p className="text-muted-foreground mb-6">
                Téléchargez les épisodes depuis le lecteur vidéo
              </p>
              <Button onClick={() => navigate('/')}>Parcourir les animes</Button>
            </GlassPanel>
          ) : (
                  ...
                  <div className="flex gap-4 mb-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <Badge variant="secondary" className="mt-1">
                        ...
                        {anime.episodes.length} épisode{anime.episodes.length > 1 ? 's' : ''}
                      </Badge>
                    </div>
                  </div>
      ...
      <Dialog open={!!deleteTarget} onOpenChange={() => setDeleteTarget(null)}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Supprimer l'épisode ?</DialogTitle>
            <DialogDescription>
              Supprimer S{deleteTarget?.season}E{deleteTarget?.episode} de "{deleteTarget?.animeTitle}" ?
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>

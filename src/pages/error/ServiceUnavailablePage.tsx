      ...
      >
        ...
        >
          ...
          <p className="text-muted-foreground text-lg">
            Nos serveurs sont actuellement surchargés ou en maintenance. Veuillez réessayer dans quelques instants.
          </p>
        </motion.div>
        ...
        >
          {[
            { label: 'API', status: 'hors ligne' },
            { label: 'CDN', status: 'dégradé' },
            { label: 'Base de données', status: 'hors ligne' },
          ].map((item, i) => (

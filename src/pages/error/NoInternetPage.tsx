...
const TEXT_VARIATIONS = [
  {
    ...
    desc: "Votre aventure anime vous attend. Vérifiez votre connexion et replongez dans des histoires sans fin."
  },
  {
    title: "Hors ligne ? Pas de souci",
    desc: "Téléchargez vos favoris et regardez-les n'importe quand, n'importe où - même sans internet."
  },
  {
    title: "Connexion perdue",
    desc: "Le monde de l'anime est à une reconnexion près. Votre liste vous attend."
  },
];
        ...
        >
          ...
          >
            ...
            <p className="text-muted-foreground text-base leading-relaxed">
              {isNative 
                ? "Vous êtes actuellement hors ligne. Pas d'inquiétude - vos animes téléchargés sont toujours disponibles dans la bibliothèque hors ligne."

        ...
        <Card className="border-red-500/30 bg-black/40 backdrop-blur-xl shadow-2xl shadow-red-500/10 overflow-hidden">
          ...
          <CardContent className="pt-8 pb-8 text-center">
            ...
            >
              ...
              <p className="text-[10px] text-muted-foreground tracking-[0.15em] uppercase">Kinshi - Interdit</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-muted-foreground">
                Votre accès à cette plateforme a été restreint.
              </p>
            </motion.div>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    <p className="font-medium text-foreground">{profile?.display_name || 'Utilisateur'}</p>
              ...
              <div className="flex items-start gap-3 text-left">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    {banReason || "Violation de nos Conditions d'utilisation. Cette décision a été prise après un examen attentif."}
                  </p>
                </div>
              </div>
            </motion.div>

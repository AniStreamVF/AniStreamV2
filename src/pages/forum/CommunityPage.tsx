...
const communityNavItems = [
  { value: 'all', label: 'Tout découvrir', icon: Sparkles },
  { value: 'forum', label: 'Forum', icon: MessageSquare },
  { value: 'tierlists', label: 'Classements', icon: Layers },
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-muted-foreground text-lg">
              Découvrez les classements et playlists partagés par la communauté
            </p>
          </div>
          ...
          <div className="relative mb-8">
            ...
            <Input
              ...
              placeholder="Rechercher des classements et playlists..."
                ...
                <SheetTrigger asChild>
                  <Button variant="outline" className="w-full justify-between h-14 px-6 bg-card/40 border-white/5 rounded-2xl">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="font-bold">Menu communautaire</span>
                    </div>
            ...
            <div className="md:w-64 lg:w-72 flex-shrink-0">
              <div className="sticky top-24 space-y-4">
                ...
                <GlassPanel className="hidden md:block p-4">
                  <h4 className="text-xs font-bold uppercase tracking-wider text-muted-foreground mb-3">Infos communautaires</h4>
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between text-sm">
                      <span className="text-muted-foreground">Nouvelles publications aujourd'hui</span>
                  ...
                  <section>
                    <div className="flex items-center justify-between mb-6">
                      <h2 className="text-2xl font-bold flex items-center gap-3">
                        ...
                        <span>Issho Ni</span>
                        <span className="text-muted-foreground text-lg font-normal hidden sm:inline">Regarder ensemble</span>
                      </h2>
                      <Button
                        variant="ghost"
                ...
                <section>
                  ...
                  {loadingTierLists ? (
                    ...
                    <GlassPanel className="p-8 text-center">
                      ...
                      <p className="text-muted-foreground">Aucun classement trouvé</p>
                    </GlassPanel>
                  )}
                </section>
                ...
                <section>
                  ...
                  {loadingPlaylists ? (
                    ...
                    <GlassPanel className="p-8 text-center">
                      ...
                      <p className="text-muted-foreground">Aucune playlist publique trouvée</p>
                    </GlassPanel>
                  )}
                </section>
              </TabsContent>
              ...
              <TabsContent value="tierlists">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <Button onClick={() => navigate('/tierlists')} className="gap-2 h-9 md:h-10 px-3 md:px-4">
                    ...
                    <span className="hidden sm:inline">Créer un classement</span>
                ...
                {loadingTierLists ? (
                  ...
                  <GlassPanel className="p-12 text-center">
                    ...
                    <h3 className="text-xl font-bold mb-2">Aucun classement trouvé</h3>
                    <p className="text-muted-foreground mb-6">
                      {searchQuery ? 'Essayez un autre terme de recherche' : 'Soyez le premier à créer un classement !'}
                    </p>
                    <Button onClick={() => navigate('/tierlists')}>Créer un classement</Button>
                  </GlassPanel>
                )}
              </TabsContent>
              ...
              <TabsContent value="playlists">
                ...
                {loadingPlaylists ? (
                  ...
                  <GlassPanel className="p-12 text-center">
                    ...
                    <p className="text-muted-foreground mb-6">
                      {searchQuery ? 'Essayez un autre terme de recherche' : 'Soyez le premier à partager une playlist !'}
                    </p>
                    <Button onClick={() => navigate('/playlists')}>Créer une playlist</Button>
                  </GlassPanel>
                )}
              </TabsContent>
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex items-center gap-2 sm:gap-4 flex-wrap">
                      ...
                      <div className="flex gap-1 bg-muted/30 p-1 rounded-lg">
                        {(['hot', 'new', 'top'] as const).map((sort) => (
                          ...
                          >
                            {{ hot: 'Populaires', new: 'Nouveaux', top: 'Meilleurs' }[sort]}
                          </button>
                        ))}
                      </div>
                      {user && (
                  ...
                  {loadingForum ? (
                    ...
                    <GlassPanel className="p-12 text-center">
                      ...
                      <p className="text-muted-foreground mb-6">
                        {searchQuery ? 'Essayez un autre terme de recherche' : 'Soyez le premier à lancer une discussion !'}
                      </p>
                      {user ? (
                        <Button onClick={() => navigate('/community/forum/new')}>Créer une publication</Button>
                      ) : (
                        <Button onClick={() => navigate('/auth')}>Connectez-vous pour publier</Button>
                      )}
                    </GlassPanel>
                  )}
                </div>
              ...
              <TabsContent value="isshoni" className="space-y-8">
                <div className="flex items-center justify-between">
                  <h2 className="text-2xl font-bold flex items-center gap-2">
                    ...
                    <span className="text-muted-foreground text-lg font-normal">Salons de visionnage</span>
                    <span className="text-sm font-normal text-muted-foreground ml-2">
                      ({watchRooms.length})
                    </span>
                  </h2>
                ...
                {loadingRooms ? (
                  ...
                  <GlassPanel className="p-12 text-center bg-gradient-to-br from-pink-500/5 to-purple-500/5">
                    ...
                    <h3 className="text-xl font-bold mb-2">Aucun salon actif</h3>
                    <p className="text-muted-foreground mb-6">
                      Soyez le premier à lancer une session de groupe !
                    </p>
                    <Button
                      onClick={() => navigate('/isshoni')}

      ...
      <main className="relative z-10 pl-6 md:pl-32 pr-6 py-6 max-w-[1800px] mx-auto pb-24 md:pb-6">
        ...
        <div className="mb-12">
          ...
          <div className="flex items-center gap-5">
            ...
            <div>
              <h1 className="text-4xl md:text-5xl font-display font-bold tracking-tight text-white/90">Calendrier de sortie</h1>
              <p className="text-muted-foreground mt-1.5 font-medium">Diffusions simultanées mondiales quotidiennes</p>
            </div>
          </div>
        </div>
        ...
        {isLoading ? (
          ...
          <GlassPanel className="p-12 text-center border-dashed border-white/10">
            <p className="text-muted-foreground font-medium">Le calendrier est actuellement indisponible</p>
          </GlassPanel>
        )}
      </main>

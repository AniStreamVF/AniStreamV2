        ...
        >
          ...
          {views && (
            <div className="px-4 py-1.5 rounded-full bg-white/10 backdrop-blur-md text-white/80 text-sm font-medium border border-white/10">
              <span className="text-orange-400 font-bold mr-1">{formatViewCount(views)}</span> regardent maintenant
            </div>
          )}
        </motion.div>
...
export default function TrendingPage() {
  ...
  const timeFrameButtons: { id: TimeFrame; label: string; icon: React.ReactNode }[] = [
    ...
    { id: 'week', label: 'Cette semaine', icon: <TrendingUp className="w-4 h-4" /> },
    { id: 'month', label: 'Ce mois', icon: <Flame className="w-4 h-4" /> },
    { id: 'all', label: 'Tout le temps', icon: <Sparkles className="w-4 h-4" /> },
  ];
      ...
      <main className={cn(
        ...
        <div className="mb-6 md:mb-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-2xl md:text-3xl font-bold">Anime tendance</h1>
              <p className="text-muted-foreground text-sm">
                Découvrez ce que tout le monde regarde en ce moment
              </p>
            </div>
          </div>
          ...
          <div className="mb-6 p-4 rounded-2xl bg-gradient-to-r from-orange-500/20 via-red-500/20 to-pink-500/20 border border-orange-500/30 backdrop-blur-md shadow-inner">
            <div className="flex flex-wrap gap-6 text-sm">
              <div className="flex items-center gap-2">
                ...
                <span className="text-muted-foreground font-medium">Suivi</span>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-muted-foreground font-medium">Le top anime a</span>
                <span className="font-black text-rose-500 text-base">
                  {formatViewCount(internalTrending[0]?.views_week || 0)}
                </span>
                <span className="text-muted-foreground">vues cette semaine</span>
              </div>
            </div>
          </div>
        )}
              ...
              <div className="space-y-12">
                <section>
                  <div className="flex items-center gap-2 mb-5">
                    ...
                    <h2 className="text-xl md:text-2xl font-bold">Tendances mondiales</h2>
                  </div>
                        ...
                        return (
                          <div key={`anilist-trending-${media.id}`} className="space-y-2">
                            ...
                            <div className="px-1 text-[10px] uppercase font-bold tracking-widest text-muted-foreground">
                              Score de tendance : {media.trending ?? media.popularity ?? 'N/A'}
                            </div>
                          </div>
                        );
                      })}
                ...
                <section>
                  <div className="flex items-center gap-2 mb-5">
                    ...
                    <h2 className="text-xl md:text-2xl font-bold">Favoris des fans</h2>
                  </div>

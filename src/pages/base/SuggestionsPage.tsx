    ...
    return (
      <div className="min-h-screen bg-background text-foreground flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mb-4">Veuillez vous connecter pour soumettre des suggestions</p>
      ...
      <main className="relative z-10 pl-6 md:pl-32 pr-6 py-6 max-w-[1400px] mx-auto pb-24 md:pb-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Aidez-nous à améliorer AniStream en partageant vos idées et commentaires
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle>Soumettre une suggestion</CardTitle>
              <CardDescription>
                Partagez vos idées de nouvelles fonctionnalités, améliorations ou signalez des bogues
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    placeholder="Titre court pour votre suggestion"
                    required
                  />
                </div>
                ...
                <div>
                  ...
                  <Select value={category} onValueChange={(value: any) => setCategory(value)}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="bug">Signalement de bogue</SelectItem>
                      <SelectItem value="improvement">Amélioration</SelectItem>
                      <SelectItem value="content">Demande de contenu</SelectItem>
                ...
                {/* Image Upload */}
                <div>
                  <label className="text-sm font-medium mb-2 block">Joindre une image (optionnel)</label>
                  {!imagePreview ? (
                    ...
                    <div className="relative rounded-lg overflow-hidden border border-muted">
                      <img src={imagePreview} alt="Aperçu" className="w-full max-h-48 object-contain bg-muted/20" />
                      <Button
                        type="button"
                        variant="destructive"
                        size="sm"
                ...
                >
                  ...
                  {isUploading ? 'Téléchargement...' : 'Soumettre la suggestion'}
                </Button>
              </form>
            </CardContent>
          </Card>
          ...
          {/* Your Suggestions */}
          <div>
            <h2 className="text-2xl font-bold mb-4">Vos suggestions</h2>
            {isLoading ? (
              ...
              <Card>
                <CardContent className="py-12 text-center text-muted-foreground">
                  ...
                  <p>Vous n'avez encore soumis aucune suggestion</p>
                </CardContent>
              </Card>
            ) : (
                  ...
                  <Card key={suggestion.id}>
                    ...
                    <CardContent>
                      ...
                      {suggestion.image_url && (
                        <div className="mt-4">
                          <img src={suggestion.image_url} alt="Pièce jointe de suggestion" className="w-full max-h-48 object-contain rounded-lg border border-muted/20" />
                        </div>
                      )}
                      ...
                      {suggestion.admin_notes && (
                        <div className="mt-4 p-3 rounded-lg bg-muted/50 border border-border/50">
                          <p className="text-xs font-medium mb-1">Réponse de l'admin :</p>

                    ...
                    <div className="w-full lg:w-80 space-y-6">
                        ...
                        <div className="p-4 rounded-2xl bg-card/40 border border-border/30 backdrop-blur-md space-y-3">
                            <div className="flex items-center justify-between">
                                <span className="text-sm text-muted-foreground uppercase tracking-widest font-bold">Favoris</span>
                ...
                <div className="w-full lg:w-80 space-y-6">
                    ...
                    {character?.status && (
                        <div className="flex items-center justify-between p-4 rounded-2xl bg-card/40 border border-border/30 backdrop-blur-md">
                                <span className="text-sm text-muted-foreground uppercase tracking-widest font-bold">Statut</span>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {character?.country && (
                            <div className="p-4 rounded-xl bg-card/30 border border-border/20 flex items-center gap-4">
                                ...
                                <div>
                                    <p className="text-[10px] uppercase font-bold text-muted-foreground tracking-widest">Village/Pays</p>
                        ...
                        {character?.clan && (
                            <div className="p-4 rounded-xl bg-card/30 border border-border/20 flex items-center gap-4">
                                ...
                                <div>
                                    <p className="text-[10px] uppercase font-bold text-muted-foreground tracking-widest">Clan/Famille</p>
                        ...
                        {(character?.powers?.length || 0) > 0 && (
                            <div className="space-y-4">
                                <div className="flex items-center gap-2">
                                    ...
                                    <h3 className="text-xl font-bold uppercase tracking-wider">Pouvoirs</h3>
                                </div>
                        ...
                        {(character?.abilities?.length || 0) > 0 && (
                            <div className="space-y-4">
                                <div className="flex items-center gap-2">
                                    ...
                                    <h3 className="text-xl font-bold uppercase tracking-wider">Capacités</h3>
                                </div>
                                <div className="flex flex-wrap gap-2">
            ...
            <main className="relative z-10 pl-4 md:pl-32 pr-4 md:pr-6 py-4 md:py-6 max-w-[1400px] mx-auto pb-24 md:pb-6">
                ...
                {isLoading ? (
                    <div className="flex flex-col items-center justify-center p-24 gap-4">
                        ...
                        <p className="text-muted-foreground italic animate-pulse">Chargement des données du personnage...</p>
                    </div>
                ) : error ? (
                    <div className="flex flex-col items-center justify-center p-24 text-center">
                        <AlertCircle className="w-16 h-16 text-destructive mb-4" />
                        <h2 className="text-2xl font-bold mb-2">Personnage introuvable</h2>
                        <p className="text-muted-foreground mb-8">
                            Nous n'avons pas trouvé le personnage "{fallbackName || charname?.replace(/-/g, ' ')}".
                        </p>
                    ...
                    <>
                        {isNumericId && jikanCharacter ? (
                            ...
                            <div className="flex flex-col items-center justify-center p-24 text-center">
                                ...
                                <h2 className="text-2xl font-bold mb-2">Personnage introuvable</h2>
                                <p className="text-muted-foreground mb-8">Aucune donnée de personnage disponible.</p>
                                <Button onClick={() => navigate(-1)}>Retour</Button>
                            </div>
                        )}
                    </>

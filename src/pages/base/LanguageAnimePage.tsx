      ...
      <main className="relative z-10 pl-6 md:pl-32 pr-6 py-6 max-w-[1800px] mx-auto pb-24 md:pb-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-3xl md:text-4xl font-bold capitalize">
                {dbData?.languageName || (language ? language.replace(/-/g, " ") : "Langue")} - Anime
              </h1>
              <p className="text-muted-foreground mt-1">
                {data ? `${data.anime.length} animes trouvés` : "Chargement..."}
              </p>
            </div>
          </div>
        </div>
        ...
        {isLoading ? (
          ...
          <GlassPanel className="p-12 text-center">
            <p className="text-muted-foreground">Aucun anime trouvé pour cette langue</p>
          </GlassPanel>
        )}
      </main>

      ...
      <main className="relative z-10 pl-6 md:pl-32 pr-6 py-6 max-w-[1800px] mx-auto pb-24 md:pb-6">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-3xl md:text-4xl font-bold">Choisissez votre langue</h1>
              <p className="text-muted-foreground mt-1">Sélectionnez une langue pour parcourir les animes</p>
            </div>
          </div>
        </div>
        ...
        {isLoading ? (
          ...
          <GlassPanel className="p-12 text-center">
            <p className="text-muted-foreground">Aucune langue disponible</p>
          </GlassPanel>
        )}
      </main>

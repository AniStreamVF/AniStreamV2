          ...
          <>
            ...
            <section className="mb-12 md:mb-16">
              <div className="relative overflow-hidden rounded-3xl border border-rose-500/30">
                <img
                  src="/manga18+.jpg"
                  alt="Bannière manga 18+"
                  className="h-44 w-full object-cover md:h-56"
                />
                <div className="absolute inset-0 bg-gradient-to-r from-black/80 via-black/40 to-black/70" />
                <div className="absolute inset-0 flex flex-col justify-end p-5 md:p-7">
                  <p className="text-[11px] font-black uppercase tracking-[0.2em] text-rose-100/90">Zone 18+</p>
                  <h2 className="mt-2 text-2xl md:text-3xl font-black tracking-tight text-white">
                    Hentai & Manga pour adultes
                  </h2>
                  <p className="mt-2 max-w-2xl text-sm text-white/80">
                    Cette section reste cachée sauf si vous confirmez avoir 18 ans et que vous vous engagez explicitement.
                  </p>
              ...
              {canShowAdultEverywhere && (
                <div className="mt-6">
                  <h3 className="mb-3 text-lg md:text-xl font-black tracking-tight">Sélections matures</h3>
                  ...
                  {queries[2].isLoading ? (
                    ...
                    <GlassPanel className="p-5 border border-rose-500/20">
                      <p className="text-sm text-muted-foreground">
                        Aucun titre mature n'a été retourné pour le moment. Ouvrez les paramètres pour ajuster les filtres et avertissements de contenu mature.
                      </p>
                      <button
                        onClick={() => navigate("/settings?tab=privacy#mature-content-controls")}

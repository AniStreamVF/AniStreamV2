# AniStream Streaming Proxy

API-only streaming proxy used by AniStream for HLS playlists and media segments.
...
- Password can be passed using one of:
  ...
  - `X-AniStream-Proxy-Password` header
...
```env
PORT=3000
ALLOWED_ORIGINS=https://AniStream.me,https://www.AniStream.me
...
## Frontend (AniStream) Configuration
Set these in the AniStream frontend environment so playback requests use this proxy:
